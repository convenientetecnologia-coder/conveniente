...
| INC-20260203-2100-01 | P0 | in_progress | needs_restart | not_run | CT Sistema Interno: Resumo divergente (KPI usa ct_drivers, abas usam ct_driver_memberships) | `in_progress/INC-20260203-2100-01.md` |
