...
| INC-20260130-0205-01 | `docs/inbox/in_progress/INC-20260130-0205-01.md` | P0 | conveniente | Governor light/full: evitar escadinha e resetar de forma correta | 5min<2GB→light; 5min>2GB→full; se 30min sem recuperar→reset total | worker.js governor + status RM4 | in_progress | not_deployed | not_run | não | sim |
