...
Write-Host ''
Write-Host '=== PRONTO ==='
Write-Host 'STATUS: Ver=v5.2.1-clean-cpu | MemClean=OFF | RebootDaily=04:00-04:20 | NetGuard=wait4min+down8min+3reboot | NetBoot=ConvenienteNetBoot | AutoStartAposBoot=SIM'
