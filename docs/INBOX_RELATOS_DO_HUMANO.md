...
| INC-20260131-0000-01 | `docs/inbox/in_progress/INC-20260131-0000-01.md` | P1 | conveniente | Nova tela “Confirme que você é humano” não é detectada; Virtus/Robe ficam ON e/ou humano é invocado cedo | Falta detector específico do pre-screen + falta buffer de 3 tentativas no captcha antes de invocar humano | (a coletar) provision_audit + detecção `detectLoginRequired` + evidências DOM | new | not_deployed | not_run | não | sim |
