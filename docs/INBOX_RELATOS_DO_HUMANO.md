...
| INC-20260130-0103-01 | `docs/inbox/in_progress/INC-20260130-0103-01.md` | P0 | sitechatbot+conveniente | CT estoque/servidores “liberar todos” causou liberação indevida de cooldowns do Robe | endpoint CT acoplado a `robes_release_all` + possível bug de seleção/broadcast | CT commands.log/ack + fetch_logs RM3 | need_evidence | not_deployed | not_run | não | sim |
