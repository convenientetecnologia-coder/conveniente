...
| INC-20260130-1521-01 | P0 | in_progress | not_deployed | not_run | CT/Servidores mostra “Desconhecido” e precisa virar fonte de verdade operacional (flags + estados acionáveis) | `in_progress/INC-20260130-1521-01.md` |
