...
|---|---|---|---|---|---|---|
| INC-20260201-0000-01 | P1 | in_progress | needs_restart | not_run | Groq config: garantir auto-download + auto-correção de modelo em TODOS os hosts após update/restart | `in_progress/INC-20260201-0000-01.md` |
