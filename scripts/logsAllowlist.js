...
function logsAllowlist() {
  ...
  const allow = {
    ...
    forensic_triagem_1: path.join(base, 'forensic_triagem.log.1'),
    forensic_triagem_2: path.join(base, 'forensic_triagem.log.2'),
    forensic_triagem_3: path.join(base, 'forensic_triagem.log.3'),
    ...
    windows_pagefile_state: path.join(base, 'logs', 'windows_pagefile.state.json'),
    windows_pagefile_forensic: path.join(base, 'logs', 'windows_pagefile.forensic.jsonl'),
    windows_pagefile_reboot: path.join(base, 'logs', 'windows_pagefile.REBOOT.txt'),
