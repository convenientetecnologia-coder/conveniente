### Timeline retroativa (como se fosse “em tempo real”) — 2026-01-19 → 2026-01-29

> **Nota (superseded)**: esta versão foi substituída pela timeline consolidada **2026-01-09 → 2026-01-29** em:
> `C:\conveniente\docs\checkups\checkup_2026-01-29_timeline_retroativa_2026-01-09_a_2026-01-29.md`

Objetivo: reconstruir os últimos ~10 dias de mudanças/incident-response como se tivéssemos escrito em tempo real, com **organização enterprise** e **evidência rastreável**.
...
- **Git (`conveniente`)**: commits com timestamp/hashes (fonte de verdade do que entrou no repo)
  - Base: `git log --since="2026-01-19" --date=iso --pretty=format:"%ad|%h|%s"`
...
- **Cursor (ouro quando não existe Git/registro humano)**:
  - “Comandos rodados + outputs”: `C:\Users\NOTIFICADOR\.cursor\projects\...\terminals\*.txt`
  - “Resultados/artefatos do agente”: `C:\Users\NOTIFICADOR\.cursor\projects\...\agent-tools\*.txt`
  - “Histórico da conversa + tool calls”: `C:\Users\NOTIFICADOR\.cursor\projects\...\agent-transcripts\*.txt`
...
- **Evidência (CT/Recovery)**:
  - arquivo “histórico” do CT já existia (mostra que o CT guardava versões): `C:\sitechatbot\_recovery\estoque.HISTORY_2026-01-19_211134.html`
  - arquivo “histórico” do CT do index: `C:\sitechatbot\_recovery\index.HISTORY_2026-01-19_211204.js`
...
- **O que**:
  ...
  - backfill nível 1/2/3 para reconstruir os 10 dias com evidência (Git/backups/recovery/Cursor).
...
### Anexo A — Onde ler os detalhes (sem lotar esta timeline)

- **Detalhe por dia (nível 1)**: `C:\conveniente\docs\checkups\checkup_2026-01-29_reconstrucao_ultimos_10_dias.md`
- **Planos/patches/backups recebidos (nível 2)**: `C:\conveniente\docs\checkups\checkup_2026-01-29_backfill_cursor_planos_patches.md`
- **Marcos “reais” do Cursor agent-tools (nível 3)**: `C:\conveniente\docs\checkups\checkup_2026-01-29_backfill_cursor_agenttools.md`
