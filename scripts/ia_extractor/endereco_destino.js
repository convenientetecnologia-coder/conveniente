// scripts/ia_extractor/endereco_destino.js

/**
 * Extrai possível endereço de DESTINO da conversa do cliente.
 * Estratégia: busca padrões básicos de endereço (rua, avenida, número, bairro, etc).
 * @param {Array} historico 
 * @returns {Object} - { endereco_destino: string|null }
 */
