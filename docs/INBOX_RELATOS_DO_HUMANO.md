...
| INC-20260207-1403-01 | `docs/inbox/need_evidence/INC-20260207-1403-01.md` | P0 | conveniente+sitechatbot | RM3: 50/50/24 (Virtus OFF em 26 perfis) apÃ³s stock_provision | quiesce_pause timeout (best-effort) + falha de resume/reconciliaÃ§Ã£o deixa Virtus OFF em massa | CT snapshot `C:\\sitechatbot\\dados\\5d7c3309-...-30b3fe928b.json` + ACK stock_provision cmdId=13ec45e0-... | need_evidence | not_deployed | not_run | nÃ£o | nÃ£o |
