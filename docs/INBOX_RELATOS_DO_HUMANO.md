...
| INC-20260130-0023-01 | `docs/inbox/in_progress/INC-20260130-0023-01.md` | P0 | conveniente+sitechatbot | RM3 recebeu conta do estoque mas não cadastrou | falha no stock_provision por provision_lock_busy (lock de human_reconcile_login_form) | CT: cmdId+ack + fetch_logs(provision_audit/status/desired) | fix_ready | not_deployed | not_run | não | sim |
